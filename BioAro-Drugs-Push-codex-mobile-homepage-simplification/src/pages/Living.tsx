...
function IconBubble({ icon: Icon, className = "" }: { icon: LucideIcon; className?: string }) {
  return (
    <span className={`flex h-12 w-12 items-center justify-center rounded-full border border-[#E1DED8] bg-[#FBF9F6] text-forest-600 ${className}`}>
...
export default function Living() {
  ...
  return (
    <div className="bg-[#FBF9F6] pt-24 text-ink md:pt-28">
        ...
        <div className="relative min-h-[720px] overflow-hidden rounded-[34px] border border-white/55 bg-ink text-white shadow-[0_32px_100px_-70px_rgba(28,24,18,0.55)] md:min-h-[800px] lg:rounded-[44px]">
          ...
          <div className="relative z-10 flex min-h-[720px] items-center px-7 py-16 md:min-h-[800px] md:px-14 lg:px-20">
            <div className="max-w-[660px]">
              <span className="text-[12px] font-semibold uppercase tracking-[0.22em] text-[#E1DED8]">Living 2.0</span>
      ...
      <section className="container-bio py-24 md:py-32">
        ...
        <div className="relative mt-14 grid gap-5 md:grid-cols-3">
          <div className="absolute left-[16.666%] right-[16.666%] top-12 hidden h-px bg-[#E1DED8] md:block" />
          {healthGapSteps.map((step, index) => (
            <div key={step.label} className="relative rounded-[30px] border border-[#E1DED8] bg-[#FBF9F6]/70 p-7 shadow-[0_24px_70px_-62px_rgba(42,34,23,0.45)]">
      ...
      <section className="border-y border-[#E1DED8] bg-[#FBF9F6] py-24 md:py-32">
        <div className="container-bio">
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-3 lg:gap-0">
            {frameworkSteps.map((step, index) => (
              <article key={step.title} className={`lg:px-10 ${index === 0 ? "lg:pl-0" : "lg:border-l lg:border-[#E1DED8]"} ${index === 2 ? "lg:pr-0" : ""}`}>
                <div className="flex items-start justify-between gap-8">
                  <span className="font-display text-[96px] leading-none text-[#E1DED8] md:text-[128px]">{step.number}</span>
                ...
                <div className="mt-8 flex flex-wrap gap-2">
                  {step.items.map((item) => (
                    <span key={item} className="rounded-full border border-[#E1DED8] bg-[#FBF9F6] px-4 py-2 text-sm text-ink/64">
                      {item}
                    </span>
                  ))}
                </div>
      ...
      <section className="container-bio py-24 md:py-32">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="relative rounded-[40px] border border-[#E1DED8] bg-[#FBF9F6] p-5 shadow-[0_34px_90px_-75px_rgba(42,34,23,0.55)] md:p-8">
            <div className="absolute inset-x-12 top-1/2 hidden h-px bg-[#E1DED8] lg:block" />
            <div className="absolute inset-y-12 left-1/2 hidden w-px bg-[#E1DED8] lg:block" />
            <div className="relative grid gap-4 sm:grid-cols-2">
              <div className="flex min-h-[220px] flex-col items-center justify-center rounded-[32px] border border-[#E1DED8] bg-[#FBF9F6] p-8 text-center sm:col-span-2">
              ...
              {ecosystemNodes.map((node) => (
                <article key={node.title} className="rounded-[28px] border border-[#E1DED8] bg-white/72 p-6">
      ...
      <section className="container-bio pb-24 md:pb-32">
        <div className="grid overflow-hidden rounded-[40px] border border-[#E1DED8] bg-[#1C1917] text-white lg:grid-cols-2">
        ...
        <div className="container-bio">
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-3">
            {upgradeModules.map((module) => (
              <article key={module.title} className="group overflow-hidden rounded-[34px] border border-[#E1DED8] bg-white shadow-[0_28px_80px_-68px_rgba(42,34,23,0.55)]">
      ...
      <section className="container-bio py-24 md:py-32">
        <div className="rounded-[40px] bg-[#1C1917] px-7 py-24 text-center text-white md:px-16 md:py-32">
      ...
      <section className="container-bio pb-24 md:pb-32">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          ...
          <div className="relative rounded-[36px] border border-[#E1DED8] bg-[#FBF9F6] p-6 md:p-8">
            <div className="absolute left-10 top-12 bottom-12 w-px bg-[#E1DED8] md:left-12 lg:left-12" />
            <div className="space-y-5">
              {journeyStages.map((stage, index) => (
                <div key={stage} className="relative flex items-center gap-5 rounded-[24px] bg-white/70 p-5">
                  <span className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#E1DED8] bg-[#FBF9F6] text-sm font-semibold text-forest-700">
                    {index + 1}
                  </span>
                  <div>
      ...
      <section className="container-bio pb-24 md:pb-32">
        <div className="grid overflow-hidden rounded-[40px] border border-[#1C1917] bg-[#1C1917] text-white lg:grid-cols-[0.95fr_1.05fr]">
          <div className="flex flex-col justify-center p-8 md:p-14 lg:p-16">
