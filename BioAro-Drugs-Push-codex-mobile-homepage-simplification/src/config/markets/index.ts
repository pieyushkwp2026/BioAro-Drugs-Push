...
export function isProductDraftInMarket(productHandle: string, market: MarketCode): boolean {
  return MARKET_CONFIGS[market].draftProductHandles?.includes(productHandle) ?? false;
}
