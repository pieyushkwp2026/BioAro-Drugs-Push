...
export default function PlaceholderBottle({ initials, accent = "#C1462A", className, style }: PlaceholderBottleProps) {
  return (
    <svg viewBox="0 0 200 220" className={className} style={style} role="img" aria-label={`${initials} product illustration`}>
      <ellipse cx="100" cy="205" rx="62" ry="10" fill="#1C1917" opacity="0.08" />
      <rect x="82" y="10" width="36" height="18" rx="4" fill="#2A6347" />
      <rect x="86" y="4" width="28" height="10" rx="3" fill="#1F4C34" />
      ...
      <rect x="66" y="158" width="46" height="3" rx="1.5" fill="#F7F4EF" opacity="0.25" />
      <defs>
