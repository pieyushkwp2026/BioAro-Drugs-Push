...
const sourceRoot = "/Users/pieyush/Documents/BioAro Drugs/bioaro-drugs-latest";
const sourceCommit = "5b47d18de0df3827975398c8dccc83058e05d3b9";

function runDryRun() {
  const output = mkdtempSync(join(tmpdir(), "bioaro-shopify-dry-run-"));
  const stdout = execFileSync(process.execPath, [script, "--source-root", sourceRoot, "--output", output], { cwd: repoRoot, encoding: "utf8" });
