      ...
      <div className="container-bio">
        ...
        <div className="mt-14 grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="mt-6 text-sm leading-relaxed text-ink/55">
              BioAro Drugs makes it easier to understand what each product is for, how it can fit into your day, and where to find support and policy information when questions arise.
            </p>
        ...
        <div className="mt-24 grid gap-5 sm:grid-cols-3">
          {[
            ...
            { icon: ShieldCheck, title: "Clear support", desc: "Policies, FAQs, and support information are easy to find when you need them." },
