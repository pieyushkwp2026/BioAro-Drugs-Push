...
const DEFAULT_SOURCE_COMMIT = "2191f22d39e952c35d0df543336496bd28b388c9";
...
function git(...args) {
  return execFileSync("git", args, { cwd: SOURCE_ROOT, encoding: "utf8" }).trimEnd();
}
...
async function main() {
  ...
  const output = path.resolve(SOURCE_ROOT, outputDirectory);
